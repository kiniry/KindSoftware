...
% $Id: JMLTutorial.tex 3098 2007-11-05 06:52:45Z leavens $
...
{\href{https://www.eecs.ucf.edu/~leavens/}{Gary T.~Leavens}\inst{1}
  \and \href{https://secure.ucd.ie/~kiniry/}{Joseph R.~Kiniry}\inst{2}
  \and \href{https://www.cs.ru.nl/~erikpoll/}{Erik Poll}\inst{3}}
\institute[UCF] % (optional, but mostly needed)
{
  \inst{1}%
  School of Electrical Engineering and Computer Science\\
  \href{https://www.ucf.edu/}{University of Central Florida}
  \and
  \inst{2}%
  School of Computer Science and Informatics \\
  \href{https://csiweb.ucd.ie/}{University College Dublin}
  \and
  \inst{3}%
  Computing Science Department \\
  \href{https://www.cs.ru.nl/}{Radboud University Nijmegen}
}
...
\begin{itemize}
\item
\href{https://www.jmlspecs.org/}{jmlspecs.org}'s download page.
\end{itemize}
...
\item
Common JML tools \\
\href{https://sourceforge.net/projects/jmlspecs/}{sourceforge.net/projects/jmlspecs/}

\item
ESC/Java2 Eclipse plugin update site \\
\href{https://sort.ucd.ie/www/escjava-eclipse/updates}{http://sort.ucd.ie/www/escjava-eclipse/updates}
\end{itemize}
\end{frame}
